...
/***/ function(module, exports, __webpack_require__) {
	...
	var jqDocReady = function jqDocReady() {
	  return new _Promise(_jquery2["default"].bind(_jquery2["default"]));
	};
	exports.jqDocReady = jqDocReady;
	...
	var getJSON = function getJSON(url) {
	  return new _Promise(function (resolve) {
	    return _jquery2["default"].getJSON(url, resolve);
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = module.exports = __webpack_require__(24)({
	  g: global,
	  core: core,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var promiseLib = _interopRequireWildcard(_LibsPromiseLib);
	...
	function main() {
	    ...
	    return _regeneratorRuntime.async(function main$(context$1$0) {
	        while (1) switch (context$1$0.prev = context$1$0.next) {
	            ...
	            case 2:
	                pre = (0, _jquery2["default"])("<pre></pre>").appendTo("body");
	
	            case 3:
	                context$1$0.next = 5;
	                return promiseLib.jqOne((0, _jquery2["default"])(document), "click");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $          = __webpack_require__(17)
	  , setUnscope = __webpack_require__(46)
	  , ITER       = __webpack_require__(28).safe('iter')
	  , $iter      = __webpack_require__(29)
	  , step       = $iter.step
	  , Iterators  = $iter.Iterators;
