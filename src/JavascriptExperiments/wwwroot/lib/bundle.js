...
/***/ function(module, exports, __webpack_require__) {
	...
	var loadScript = function loadScript(url) {
	    return new _Promise(function (resolve, reject) {
	        (0, _scriptloader2["default"])(url, function (err, script) {
	            if (err) {
	                reject(err);
	            } else {
	                resolve(script);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var listenOnce = function listenOnce(event) {
	    var item = this;
	    return new _Promise(function (resolve) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.monitorImages = monitorImages;
	
	var _net = __webpack_require__(2);
	
	var _arrayUtils = __webpack_require__(11);
	...
	function handleNewImageElement(elem, cb) {
	    ...
	    elems.forEach(function (elem) {
	        //console.log(elem);
	        if (elem.complete) {
	            getImageSizeAsync(elem.src).then(function (size) {
	                cb(elem, size);
	            });
	        } else {
	            var f;
	...
	function monitorImages(cb) {
	    var existingImages, mo;
	    return _regeneratorRuntime.async(function monitorImages$(context$1$0) {
	        while (1) switch (context$1$0.prev = context$1$0.next) {
	            case 0:
	                context$1$0.next = 2;
	                return (0, _net.loadScript)("//cdnjs.cloudflare.com/ajax/libs/webcomponentsjs/0.6.1/webcomponents-lite.min.js");
	
	            case 2:
	                existingImages = Array.prototype.slice.call(document.getElementsByTagName("img"));
	
	                existingImages.forEach(function (im) {
	                    return handleNewImageElement(im, cb);
	                });
	                mo = new MutationObserver(function (records) {
	                    (0, _arrayUtils.flatten)(records.filter(function (r) {
	                        return r.type == "childList";
	                    }).map(function (r) {
	                        return r.addedNodes;
	                    })).forEach(handleNewImageElement);
	                    records.filter(function (r) {
	                        return r.type == "attributes" && r.target.nodeType == 1 && r.target.localName == "img" && !(r.target.src == null || r.target.src == "");
	                    }).map(function (r) {
	                        return r.target;
	                    }).forEach(handleNewImageElement);
	                });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Symbol$iterator = __webpack_require__(14)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LibsPromiseLib = __webpack_require__(3);
	
	var _LibsNet = __webpack_require__(2);
	
	var _LibsImage = __webpack_require__(4);
	
	var _LibsMemoize = __webpack_require__(5);
	
	var get = _LibsMemoize.memoize.call(_LibsNet.getJSON);
	...
	function main() {
	    ...
	    return _regeneratorRuntime.async(function main$(context$1$0) {
	        ...
	        while (1) switch (context$1$0.prev = context$1$0.next) {
	            case 0:
	                context$1$0.next = 2;
	                return (0, _LibsPromiseLib.docReady)();
	
	            case 2:
	                urlMap = {};
	
	                (0, _LibsImage.monitorImages)(function callee$1$0(elem, originalSize) {
	                    var url;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $        = __webpack_require__(21)
	  , setTag   = __webpack_require__(29).set
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $          = __webpack_require__(21)
	  , setUnscope = __webpack_require__(47)
	  , ITER       = __webpack_require__(32).safe('iter')
	  , $iter      = __webpack_require__(33)
	  , step       = $iter.step
	  , Iterators  = $iter.Iterators;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assertObject = __webpack_require__(38).obj;
